...
<?php if ($table === 'leads'): ?>
<form method="post" action="<?= e(app_url('/leads/convert')) ?>" class="mt-3">
...
<form method="post" action="<?= e(app_url('/attendance/clock')) ?>"><input type="hidden" name="action" value="in"><button class="btn btn-success">Clock In</button></form>
<form method="post" action="<?= e(app_url('/attendance/clock')) ?>"><input type="hidden" name="action" value="out"><button class="btn btn-danger">Clock Out</button></form>
</div>
<?php endif; ?>
