...
- **404 on installer or routes in localhost**: if app is inside a folder (e.g., `htdocs/crm`), open `http://localhost/crm/installer.php` (not `http://localhost/installer.php`).
